...
class EscolaSerializer(serializers.ModelSerializer):
    ...
    SalaSemObjetosSerializer, CardapioMerendaSerializer e MuralAvisosSerializer para serialização
    de telefones, e-mails, salas, cardápios de merenda e murais de avisos associados à escola.
    ...
    Atributos:
        ...
        objetos_salas (list): Uma lista de objetos salas associadas à escola.
