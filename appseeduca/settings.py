...
CORS_ALLOW_ALL_ORIGINS = True if os.environ.get('CORS_ALLOW_ALL_ORIGINS') == '1' else False

# CORS_ALLOWED_ORIGINS = [
#     "exp://192.168.0.67:19000",  # Substitua pelo IP do seu Expo
# ]

ROOT_URLCONF = 'appseeduca.urls'
